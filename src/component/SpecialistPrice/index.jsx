...
function SpecialistPriceBlock() {
  ...
  React.useEffect(() => {
    const handleScroll = () => {
      ...
      if (
        scrollPosition >
        element.offsetTop - windowHeight * 0.8
      ) {
  ...
  return (
    <section
      ref={specialistPriceBlock}
      className='specialistPriceBlock'
    >
      <motion.h3
      ...
      <motion.div className='specialistPriceBlock__block'>
        ...
        >
          <li>
            <p className='specialistPriceBlock__list-title'>
              Плата за отклик
            </p>
          </li>
          <li>
            ...
            <p>
              Больше комиссий нет, но не каждый отклик
              приводит к заказу.
            </p>
          </li>
          <li>
